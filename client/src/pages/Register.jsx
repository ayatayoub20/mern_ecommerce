...
const Register = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    console.log(inputs);
    // I will use axios to connect with backend
  }
  ...
  return (
    ...
    >
      ...
      <div className="mb-2">
        <label
          className="float-left text-gray-500 mb-2 font-bold"
      ...
      <div className="float-left flex flex-col justify-between items-center my-3 mb-5">
